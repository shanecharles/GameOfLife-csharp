...
namespace GameOfLife.Tests
{
    ...
    {
        [Test]
        public void Empty_world_is_empty()
        {
            var world = new World(new List<Settlement>());
            Assert.False(world.Settlements.Any());
        }

        [Theory]
        public void Settlement_should_have_eight_potential_neighbours(Settlement settlement)
        {
            var potentialNeighbours = World.GenerateNeighbours(settlement);
        ...
        {
            var potentialNeighbours = World.GenerateNeighbours(Origin1);
        ...
        {
            var neighbours = World.GenerateNeighbours(Origin100);
